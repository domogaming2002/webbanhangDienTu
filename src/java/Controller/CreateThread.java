 ...
 * @author ADMIN
 */
@WebServlet(name = "CreateThread", urlPatterns = {"/chat"})
public class CreateThread extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!checkThread(us.getUserId())) {
            dao.insertThread(us.getUserId(),false);
            dao.loadThread();
        }
        threadId = getThreadId(us.getUserId());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String userIdto = "Admin";
        dao.insertChat(threadId, userIdsend, chat, userIdto);
        dao.updateThread(threadId, false);
