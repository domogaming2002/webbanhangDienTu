...
//        processRequest(request, response);
        ...
        if (user == null) {
            ...
            if (user.isActive() == false) {
                ses.setAttribute("userVerify", user);
                response.sendRedirect("VerifyServlet");
            } else {

                ses.setAttribute("user", user);
//            Cookie c = new Cookie("user",user.getAdmin()+user.getUserId());
...
//            response.addCookie(c);
    ...
    public User checkUser(String userId, String pass) {
        for (User us : dao.getUsList()) {
            if (us.getUserId().equals(userId) && us.getPass().equals(pass)) {
                return us;
            }
        }
        return null;
